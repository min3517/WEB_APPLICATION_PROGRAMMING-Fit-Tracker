                    ...
                    tooltip: {
                        callbacks: {
                            label: function (context) {
                                ...
                                if (ds.label === '초과 섭취') {
                                    if (val === 0) return '';
                                    return `초과: ${val.toFixed(0)} kcal`;
                                }
                                if (ds.label === '섭취 칼로리') {
                                    if (context.dataIndex === 1) return `잔여: ${val.toFixed(0)} kcal`;
                                    return `섭취: ${val.toFixed(0)} kcal`;
                                }

                                if (ds.label === '소모 칼로리') {
                                    if (context.dataIndex === 1) return ''; 
                                    return `소모: ${val.toFixed(0)} kcal`;
                                }

                                return `${ds.label}: ${val.toFixed(0)} kcal`;
                            }
                        }
                    }
